...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.barcode_print_pushButton = QPushButton(self.frame)
        self.barcode_print_pushButton.setObjectName(u"barcode_print_pushButton")
        self.barcode_print_pushButton.setGeometry(QRect(7, 190, 251, 51))
        self.barcode_print_pushButton.setFont(font)
        self.check_job_pushButton = QPushButton(self.frame)
