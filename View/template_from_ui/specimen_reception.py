...
################################################################################
## Form generated from reading UI file 'specimen_reception.ui'
##
...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.table_staff = QTableWidget(Form)
        ...
        self.label_barcode = QLabel(Form)
        ...
        self.dt_received = QDateTimeEdit(Form)
        ...
        self.label_receiver = QLabel(Form)
        ...
        self.le_receiver = QLineEdit(Form)
        ...
        self.label_receiver_id = QLabel(Form)
        ...
        self.le_receiver_id = QLineEdit(Form)
    ...
    def retranslateUi(self, Form):
        Form.setWindowTitle(QCoreApplication.translate("Form", u"Lab Received Sample", None))
        Form.setStyleSheet("")
        self.label_title.setText(QCoreApplication.translate("Form", u"Lab Received sample", None))
        self.label_search.setText(QCoreApplication.translate("Form", u"\u0e04\u0e49\u0e19\u0e2b\u0e32\u0e0a\u0e37\u0e48\u0e2d\u0e40\u0e08\u0e49\u0e32\u0e2b\u0e19\u0e49\u0e32\u0e17\u0e35\u0e48", None))
        ___qtablewidgetitem = self.table_staff.horizontalHeaderItem(0)
        ___qtablewidgetitem.setText(QCoreApplication.translate("Form", u"\u0e0a\u0e37\u0e48\u0e2d", None));
        ___qtablewidgetitem1 = self.table_staff.horizontalHeaderItem(1)
        ___qtablewidgetitem1.setText(QCoreApplication.translate("Form", u"\u0e19\u0e32\u0e21\u0e2a\u0e01\u0e38\u0e25", None));
        ___qtablewidgetitem2 = self.table_staff.horizontalHeaderItem(2)
        ___qtablewidgetitem2.setText(QCoreApplication.translate("Form", u"\u0e2b\u0e21\u0e32\u0e22\u0e40\u0e25\u0e02\u0e1b\u0e23\u0e30\u0e08\u0e33\u0e15\u0e31\u0e27", None));
        self.btn_select.setText(QCoreApplication.translate("Form", u"\u0e40\u0e25\u0e37\u0e2d\u0e01\u0e23\u0e32\u0e22\u0e0a\u0e37\u0e48\u0e2d", None))
        self.label_barcode.setText(QCoreApplication.translate("Form", u"\u0e23\u0e2b\u0e31\u0e2a\u0e1a\u0e32\u0e23\u0e4c\u0e42\u0e04\u0e49\u0e14\u0e2a\u0e34\u0e48\u0e07\u0e2a\u0e48\u0e07\u0e15\u0e23\u0e27\u0e08", None))
        self.label_datetime.setText(QCoreApplication.translate("Form", u"\u0e27\u0e31\u0e19\u0e40\u0e27\u0e25\u0e32\u0e17\u0e35\u0e48\u0e23\u0e31\u0e1a\u0e2a\u0e34\u0e48\u0e07\u0e2a\u0e48\u0e07\u0e15\u0e23\u0e27\u0e08", None))
        self.label_receiver.setText(QCoreApplication.translate("Form", u"\u0e1c\u0e39\u0e49\u0e23\u0e31\u0e1a\u0e2a\u0e34\u0e48\u0e07\u0e2a\u0e48\u0e07\u0e15\u0e23\u0e27\u0e08", None))
        self.label_receiver_id.setText(QCoreApplication.translate("Form", u"\u0e2b\u0e21\u0e32\u0e22\u0e40\u0e25\u0e02\u0e1b\u0e23\u0e30\u0e08\u0e33\u0e15\u0e31\u0e27", None))
        self.btn_save.setText(QCoreApplication.translate("Form", u"\u0e1a\u0e31\u0e19\u0e17\u0e36\u0e01\u0e02\u0e49\u0e2d\u0e21\u0e39\u0e25", None))
    # retranslateUi
